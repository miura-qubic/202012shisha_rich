...
$contact_type = htmlspecialchars($_POST['contact_type'], ENT_QUOTES, "utf-8");
...
//管理者受信用メール送信処理
function funcManagerAddress($name, $company, $email, $phone, $contact_type, $msg)
{

  // $mailto = 'info@qu-bic.jp'; // 管理者当てメール、カンマで複数設定可能
  $mailto = 'miura@qu-bic.jp'; // 管理者当てメール、カンマで複数設定可能
...
//送信者用自動返信メール送信処理
function funcContactAddress($name, $company, $email, $phone, $contact_type, $msg)
{
  $mailto = $email;
  ...
  // $mailfrom = "From:" . mb_encode_mimeheader("Shisha Rich") . "<'info@qu-bic.jp'>";
  $mailfrom = "From:" . mb_encode_mimeheader("Shisha Rich") . "<'miura@qu-bic.jp'>";
...
//送信者用自動返信メール送信
$contactAddress = funcContactAddress($name, $company, $email, $phone, $contact_type, $msg);
//管理者受信用メール送信
$managerAddress = funcManagerAddress($name, $company, $email, $phone, $contact_type, $msg);
